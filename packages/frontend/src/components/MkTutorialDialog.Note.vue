...
<div v-else-if="phase === 'howToReact'" class="_gaps">
	...
	<div v-if="onceReacted"><b style="color: #20d9bc;"><i class="ti ti-check"></i> {{ i18n.ts._initialTutorial.wellDone }}</b> {{ i18n.ts._initialTutorial._reaction.reactNotification }}<br>{{ i18n.ts._initialTutorial._reaction.reactDone }}</div>
</div>
</template>
