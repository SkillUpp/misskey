...
<div class="_gaps">
	...
	></MkPostForm>
	<div v-if="onceSucceeded"><b style="color: #20d9bc;"><i class="ti ti-check"></i> {{ i18n.ts._initialTutorial.wellDone }}</b> {{ i18n.ts._initialTutorial._howToMakeAttachmentsSensitive.sensitiveSucceeded }}</div>
	<MkFolder>
